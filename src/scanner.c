/*
This was taken from tree-sitter-cpp! This was not written by me! All credit to original authors!
I only replaced tree_sitter_cpp with tree_sitter_metal

https://raw.githubusercontent.com/tree-sitter/tree-sitter-cpp/refs/heads/master/src/scanner.c
*/
...
void *tree_sitter_metal_external_scanner_create() {
    Scanner *scanner = (Scanner *)ts_calloc(1, sizeof(Scanner));
    memset(scanner, 0, sizeof(Scanner));
    return scanner;
}

bool tree_sitter_metal_external_scanner_scan(void *payload, TSLexer *lexer, const bool *valid_symbols) {
...
unsigned tree_sitter_metal_external_scanner_serialize(void *payload, char *buffer) {
...
void tree_sitter_metal_external_scanner_deserialize(void *payload, const char *buffer, unsigned length) {
...
void tree_sitter_metal_external_scanner_destroy(void *payload) {
    Scanner *scanner = (Scanner *)payload;
    ts_free(scanner);
}
